...
EVENTS_SP: dict[int, dict[str, Alert | AlertCallbackType]] = {
  ...
  EventNameSP.trafficModeOn: {
    ET.WARNING: NormalPermanentAlert("Traffic Mode On", duration=1.5)
  },

  EventNameSP.trafficModeOff: {
    ET.WARNING: NormalPermanentAlert("Traffic Mode Off", duration=1.5)
  },
